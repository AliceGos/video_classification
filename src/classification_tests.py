...
train_formodel  = train.copy(deep=True)  # can be switched to train_all if explore results on surf+longboard
test_formodel   = test.copy(deep=True)   # can be switched to test_all if explore results on surf+longboard
y_test_formodel = y_test.copy(deep=True) # can be switched to y_test_all if explore results on surf+longboard
kfold = 4
